    ...
    <div>
      ...
      >
        <input
          ...
          v-model="checkedValues"
        />
        <label class="form-check-label ms-2" :for="sociodemographicCheckbox.cod[i - 1]">{{
          sociodemographicCheckbox.title[i - 1]
        }}</label>
      </div>
    </div>
</template>
    ...
    export default {
        data () {
            return {
                ...
                sociodemographicCheckbox: API_INFO[this.$route.params.id]["Sociodemographic"],
                checkedValues: [],
            }
        },
        emits: ["checkedValues"],
